...
export default function ContactForm() {
  ...
  function submitFormHandler(event: React.FormEvent) {
    ...
    const validationErrors: string[] = [];
    const invalidFieldsTemp: string[] = [];
    ...
    if (!enteredLastName) {
      ...
      invalidFieldsTemp.push("lastName");
    }
    if (!enteredEmail || !/\S+@\S+\.\S+/.test(enteredEmail)) {
      validationErrors.push("Valid Email is required.");
      invalidFieldsTemp.push("email");
    }
    if (!enteredSubject) {
      validationErrors.push("Subject is required.");
      invalidFieldsTemp.push("subject");
    }
  ...
  return (
    <div className="flex py-6 flex-col">
      ...
      <form onSubmit={submitFormHandler} className="flex flex-col">
        ...
        {/* First Name */}
        <label htmlFor="firstName" className="text-[17px] text-[#6b6969] font-[400] tracking-normal mt-3 leading-[25.5px] font-sans">
          First Name *
        </label>
        <input
          type="text"
          id="firstName"
          ref={nameInputRef}
          className={`bg-gray-100 border-solid transition-all cursor-pointer duration-500 ease-in-out focus:outline-none hover:bg-[#C6C6C6] border-[1px] px-3 mt-2 lg:w-[405px] w-[350] h-[45px] ${getInputClasses("firstName")}`}
        />

        {/* Last Name */}
        <label htmlFor="lastName" className="text-[17px] text-[#6b6969] font-[400] tracking-normal mt-3 leading-[25.5px] font-sans">
          Last Name *
        </label>
        <input
          type="text"
          id="lastName"
          ref={lastNameInputRef}
          className={`bg-gray-100 border-solid transition-all cursor-pointer duration-500 ease-in-out focus:outline-none hover:bg-[#C6C6C6] border-[1px] px-3 mt-2 lg:w-[405px] w-[350] h-[45px] ${getInputClasses("lastName")}`}
        />

        {/* Email */}
        <label htmlFor="email" className="text-[17px] text-[#6b6969] font-[400] tracking-normal mt-3 leading-[25.5px] font-sans">
          Email *
        </label>
        <input
          type="email"
          id="email"
          ref={emailInputRef}
          className={`bg-gray-100 border-solid transition-all cursor-pointer duration-500 ease-in-out focus:outline-none hover:bg-[#C6C6C6] border-[1px] px-3 mt-2 lg:w-[405px] w-[350] h-[45px] ${getInputClasses("email")}`}
        />

        {/* Subject */}
        <label htmlFor="subject" className="text-[17px] text-[#6b6969] font-[400] tracking-normal mt-3 leading-[25.5px] font-sans">
          Subject *
        </label>
        <input
          type="text"
          id="subject"
          ref={subjectInputRef}
          className={`bg-gray-100 border-solid transition-all cursor-pointer duration-500 ease-in-out focus:outline-none hover:bg-[#C6C6C6] border-[1px] px-3 mt-2 lg:w-[405px] w-[350] h-[45px] ${getInputClasses("subject")}`}
        />

        {/* Message */}
        <label htmlFor="message" className="text-[17px] text-[#6b6969] font-[400] tracking-normal mt-3 leading-[25.5px] font-sans">
          Message 
        </label>
        <textarea
          id="message"
