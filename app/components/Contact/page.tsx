...
export default function Contact() {
    return <div id="contact" className="w-full  pb-6 pt-28 h-full px-16">
        <div className=" flex flex-col justify-center items-center">
            <p className="text-center text-[37px] lg:text-[55px] text-[#1E2D3B] leading-normal font-semibold font-seans">CONTACT</p>
        ...
        <div className="flex justify-center w-full items-center p-16 ">
            <iframe
                ...
                width="600"
                height="450"
                className="border-0 rounded-md  w-auto h-[300px] lg:w-[70%]  lg:h-[450px]"
                allowFullScreen
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
            ></iframe>
        </div>
        <div className="flex  md:p-15 flex-col md:flex-row justify-center md:justify-start md:ml-[18%]  gap-[100px] ">
            <div className="flex flex-col">
                <p className="text-[25px] font-sans font-bold leading-normal text-[#1e2d3b]">Inquiries</p>
                <p className="text-[17px] text-[#6b6969] font-[400] tracking-normal mt-3 leading-[25.5px] font-sans w-[270px] lg:w-[415.9px] lg:h-[51px]">For any inquiries, questions or commendations, please call: 123-456-7890 or fill out the following form</p>
                <ContactForm />
            </div>
            <div className="flex flex-col">
